...
import { getTeachers, createTeacher, updateTeacher, uploadImage } from '../../api/endpoints';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (imageFile) {
                ...
                avatarUrl = data.url.startsWith('http')
                    ? data.url
                    : `${(import.meta as any).env.VITE_API_URL || 'http://localhost:5000'}${data.url}`;
            }
