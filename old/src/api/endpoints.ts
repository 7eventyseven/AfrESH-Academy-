...
export const updateCourse = (id: string, courseData: any) => api.put(`/courses/${id}`, courseData);
...
export const createPortfolio = (portfolioData: any) => api.post('/portfolio', portfolioData);
export const updatePortfolio = (id: string, portfolioData: any) => api.put(`/portfolio/${id}`, portfolioData);
...
export const createTeacher = (teacherData: any) => api.post('/teachers', teacherData);
export const updateTeacher = (id: string, teacherData: any) => api.put(`/teachers/${id}`, teacherData);
