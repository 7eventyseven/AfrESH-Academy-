...
const ContactUs: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="relative min-h-screen pt-16 sm:pt-20 pb-0">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
                    ...
                    <Link
                        href="/"
                        className="mb-6 sm:mb-8 text-white hover:text-gray-200 transition-colors flex items-center gap-2 inline-flex text-sm sm:text-base"
                    >
                    ...
                    <div className="text-center mb-8 sm:mb-12">
                        <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-white mb-3 sm:mb-4">Contact Us</h1>
                    ...
                    {/* Main Contact Card */}
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-5 sm:p-8 md:p-12 max-w-6xl mx-auto">
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 text-white/70">
                                {['Home', 'About', 'Services', 'Testimonials', 'Contact Us'].map(link => (
                                    <li key={link}>
                                        <Link
                                            href={link === 'Home' ? '/' : (link === 'About' ? '/about' : (link === 'Services' ? '/courses' : '#'))}
