...
const AboutUs: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[50vh] h-[60vh] flex items-center overflow-hidden pt-16 sm:pt-20">
      ...
      {/* Statistics Section */}
      <section className="bg-[#483C5C] py-8 sm:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 text-center">
            ...
            <div>
              <div className="text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-1 sm:mb-2">95%</div>
              <div className="text-white/80 text-sm md:text-base">Success Rate</div>
            </div>
            <div>
              <div className="text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-1 sm:mb-2">200+</div>
              <div className="text-white/80 text-sm md:text-base">Courses</div>
            </div>
            <div>
              <div className="text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-1 sm:mb-2">400+</div>
      ...
      <section className="py-16 sm:py-24 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-16 sm:mb-20">
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-md p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-[#483C5C] shrink-0" />
                <h3 className="text-lg sm:text-xl font-bold text-gray-900">Our Mission</h3>
              </div>
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
                To empower individuals worldwide with the skills and knowledge they need to pursue their passion, and enhance their professional goals. We envision a future where quality education knows no boundaries.
              </p>
            </div>
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-md p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
                To empower individuals worldwide with the skills and knowledge they need to conquer the digital age. We&apos;re developing practical courses that transform careers and change lives through accessible online education.
              </p>
            </div>
          </div>
          ...
          <div className="text-center mb-10 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Our Values</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-10 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#483C5C] rounded-full flex items-center justify-center mx-auto mb-4">
                <Star className="w-7 h-7 sm:w-8 sm:h-8 text-white" />
              </div>
              <h4 className="text-lg font-bold text-gray-900 mb-2">Excellence</h4>
              <p className="text-gray-600 text-sm leading-relaxed">
                We strive for the highest quality in everything we do, ensuring our learners receive only the best education.
              </p>
            </div>
            <div className="text-center">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#483C5C] rounded-full flex items-center justify-center mx-auto mb-4">
                <Accessibility className="w-7 h-7 sm:w-8 sm:h-8 text-white" />
              </div>
              <h4 className="text-lg font-bold text-gray-900 mb-2">Accessibility</h4>
              <p className="text-gray-600 text-sm leading-relaxed">
                Education should be for everyone. We make quality learning affordable, inclusive, and distributed.
              </p>
            </div>
            <div className="text-center">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#483C5C] rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Building a supportive, collaborative, and diverse community where everyone belongs.
              </p>
            </div>
            <div className="text-center">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#483C5C] rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Continuously seeking new and better ways of doing things, embracing and promoting new ideas.
              </p>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-white/70">
                {['Home', 'About Us', 'Courses', 'Contact Us'].map(link => (
                  <li key={link}><Link href={link === 'Home' ? '/' : (link === 'About Us' ? '/about' : (link === 'Courses' ? '/courses' : '/contact'))} className="hover:text-white transition-colors">{link}</Link></li>
                ))}
              </ul>
            </div>
            <div>
